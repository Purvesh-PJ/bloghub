import { Form, FormContainer, Divider, FormHeading, UserImage } from "./UpdateProfile-Style";
...
const UpdateProfile = () => {
    ...
    const { user, setUserWithProfile, getUserLoading, updateUserLoading, getUserError } = useUserActions(true);
    ...
    return (
        ...
        <Form onSubmit={updateUserProfile}>
            ...
            <Divider />
            { getUserError && <div style={{ margin : 'auto'}}>Error</div> }
            { !getUserError && getUserLoading && <div style={{ margin : 'auto'}}>Loading...</div> }
            { !getUserLoading && !getUserError && (
                
                <FormContainer>
                
                    <UserImage style={{ margin : '1%'}} 
