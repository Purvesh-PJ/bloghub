...
export const Tab = styled.div`
  ...
  border-bottom: 2px solid ${props => props.active ? 'oklch(27.8% 0.033 256.848)' : 'transparent'};
  cursor: pointer;
  white-space: nowrap;
  transition: all 0.2s ease;
  
  &:hover {
    color: ${props => props.active ? 'oklch(27.8% 0.033 256.848)' : 'oklch(37.3% 0.034 259.733)'};
  }
...
export const CardHeader = styled.div`
  padding: 0.2rem 0.2rem 0.20rem 0.20rem;
  display: flex;
  align-items: center;
