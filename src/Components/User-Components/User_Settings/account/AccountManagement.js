      ...
      {showConfirmation && (
        <ConfirmationModal>
          <ModalContent>
            ...
            <ModalActions>
              <ModalButton secondary onClick={closeConfirmation}>Cancel</ModalButton>
              <ModalButton danger onClick={deleteAccount}>Delete Account</ModalButton>
            </ModalActions>
          </ModalContent>
        </ConfirmationModal>
      )}
