import { Container, ProfileImage, DropdownMenu, DropdownItem, ListLabel, ListIcons } from './UserSignedIn-Style';
  ...
  return (
    <Container>
        ...
        {isOpen && (
            <DropdownMenu>
                {
                    UserSignedDropdownData && UserSignedDropdownData?.map((listItem, index) => (
