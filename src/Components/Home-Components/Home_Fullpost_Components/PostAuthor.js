import { Container, ProfileImage, Username } from './PostAuthor-Style';
...
import { follow, unfollow, isFollowing } from '../../../services/userApi';
...
const PostAuthor = (props) => {
    ...
    return ( 
        <Container>
            ...
            <MultiUseButton outlined btnText={isFollowed ? 'Unfollow' : 'Follow'} size='sm' onClick={handleFollowOrUnfollow}/>
        </Container>
    );
}
