  ...
  return (
    <HeaderContainer scrolled={isScrolled}>
      ...
      <AuthButtons>
        {isAuthenticated ? (
          <>
            <SignUpButton onClick={() => navigate('/create-post')}>
              Write a Post
            </SignUpButton>
      ...
      <MobileMenu isOpen={isMobileMenuOpen}>
        ...
        <NavLink to="/explore" active={isActive('/explore')} onClick={() => setIsMobileMenuOpen(false)}>
          Explore
        </NavLink>
        <NavLink to="/categories" active={isActive('/categories')} onClick={() => setIsMobileMenuOpen(false)}>
          Categories
        </NavLink>
        <NavLink to="/about" active={isActive('/about')} onClick={() => setIsMobileMenuOpen(false)}>
          About
        </NavLink>
        <NavLink to="/contact" active={isActive('/contact')} onClick={() => setIsMobileMenuOpen(false)}>
          Contact
        </NavLink>
