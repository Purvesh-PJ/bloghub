...
// Modern hero image
const heroImage = "https://images.unsplash.com/photo-1499750310107-5fef28a66643?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80";
...
const HeroSection = () => {
  ...
  const tags = [
    ...
    'Science', 'Business', 'Art', 'Photography', 'Music'
  ];
      ...
      <HeroSplit>
        <ContentSide>
          ...
          <HeroSubtitle>
            ...
            Discover stories that inspire, inform, and entertain.
          </HeroSubtitle>
