...
import { 
    ...
    RoleBadge,
    TableRow
} from './Page_AdminManageUsers-Style';
...
const Page_AdminManageUsers = () => {
    ...
    const renderRoleCell = ({ value }) => {
        ...
        return (
            <RoleBadge className={isAdmin ? 'admin' : 'member'}>
                {value}
            </RoleBadge>
        );
    };
            ...
            <CardContainer>
                ...
                <div style={{ 
                    ...
                    <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>
                        Showing {pageIndex * pageSize + 1} to {Math.min((pageIndex + 1) * pageSize, userData.length)} of {userData.length} users
                    </div>
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                        <IconButton 
                            onClick={() => gotoPage(0)} 
