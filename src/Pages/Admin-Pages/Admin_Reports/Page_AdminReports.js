    ...
    const samplePostReports = useMemo(() => [
        {
            ...
            status: 'pending',
            reason: 'This post contains misleading information about AI technology that could be harmful.',
            content: 'The future of AI is not about replacing humans, but rather augmenting human capabilities to solve complex problems that were previously unsolvable...',
            postId: 101,
        ...
        },
        {
            ...
            status: 'reviewing',
            reason: 'This article appears to be copied from another website without proper attribution.',
            content: 'React has become the most popular frontend framework for building modern web applications. Its component-based architecture allows developers to create reusable UI elements...',
            postId: 102,
        ...
        },
        {
            ...
            content: 'The debate around programming languages can get heated, but it\'s important to remember that each language has its strengths and weaknesses...',
            postId: 103,
        ...
        },
        {
            ...
            content: 'Looking for the best web hosting service? Look no further than HostPro! Our blazing fast servers and 24/7 customer support make us the top choice for developers...',
            postId: 104,
    ...
    const sampleCommentReports = useMemo(() => [
        {
            ...
            content: 'You clearly don\'t understand how programming works. Maybe you should stick to something simpler.',
            postId: 101,
            postTitle: 'The Dark Side of Artificial Intelligence',
            commentId: 201
        },
        {
            ...
            content: 'Great article! By the way, check out my new e-book on making money online at www.example.com',
            postId: 102,
            postTitle: 'React Best Practices for 2025',
            commentId: 202
        },
        ...
        if (error) {
            return (
                <ErrorContainer>
                    ...
                    <ErrorTitle>Error Loading Reports</ErrorTitle>
                                ...
                                <ReportHeader>
                                    <ReportInfo>
                                        ...
                                        <ReportMeta>
                                            ...
                                            <ReportMetaItem>
                                                <Flag size={14} />
                                                {activeTab === 'posts' ? 'Post' : 'Comment'} #{activeTab === 'posts' ? report.postId : report.commentId}
                                            </ReportMetaItem>
                                        </ReportMeta>
                                    </ReportInfo>
                                    <ReportStatus>
