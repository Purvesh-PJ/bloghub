...
export const postCategoryCollection = async(categories, postId) => {
    ...
    try {
        const response = await api.post(`${API_CATEGORIES_URL}/categoriesCollection`, { categories, postId }, { 
                headers : {
...
export const updateCategoryCollection = async(selectedCategories, removedCategories, postId) => {
    try {
        const response = await api.put(`${API_CATEGORIES_URL}/updateCategoriesCollection/${postId}`, { selectedCategories, removedCategories }, 
            { 
                headers : {
                    'Content-Type' : 'application/json'
                } 
