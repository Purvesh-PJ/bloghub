...
router.get('/all', AuthUser.authenticateUser, AuthUser.authorizeAdmin, UserActivityController.getAllUserActivity);
...
router.get('/moderation-log', AuthUser.authenticateUser, AuthUser.authorizeAdmin, UserActivityController.getModerationLog);
