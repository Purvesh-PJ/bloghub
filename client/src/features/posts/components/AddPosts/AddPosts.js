    ...
    <FormContainer onSubmit={handleSubmit}>
      {showSuccessMessage && (
        <Alert $variant="success">
          ...
          <Alert.Content>Post {edit ? 'updated' : 'created'} successfully!</Alert.Content>
        </Alert>
      )}
      ...
      {error && !dismissedError && (
        <Alert $variant="error" $dismissible>
          ...
          <Alert.Close onClick={() => setDismissedError(true)}>
            <RiCloseLine size={18} />
          </Alert.Close>
        </Alert>
      )}
        ...
        <SidebarContainer>
          ...
          <Section>
            ...
            <HelpText>
              ...
              <HelpLink onClick={generateSlug}>click here</HelpLink> to generate now.
            </HelpText>
          </Section>
          ...
          <Section>
            ...
            <CategoryContainer>
              ...
              <LabelTop>Selected categories:</LabelTop>
              <CatsContainer>
