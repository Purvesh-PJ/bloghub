import { Container } from './Page_AdminDataManagement.styles';
import { MainContainer } from '../AddPosts/Page_AdminAddPosts.styles';
...
import {
  ...
  ActionBar,
  ButtonText,
} from './Page_AdminDataManagement.styles';
...
const Page_AdminManageData = () => {
  ...
  return (
    <Container>
      <Header>
        ...
        {filterOpen && (
          <FilterContainer>
            ...
            <Button small onClick={() => setFilterOpen(false)}>
              Apply Filters
            </Button>
          </FilterContainer>
        )}
      ...
      <MainContainer>
        <Table data={filteredData} columns={columns} onRowSelect={handleRowSelect} />
      </MainContainer>
    </Container>
  );
};
