...
const Page_AdminModerationLog = () => {
  ...
  const moderationLogs = [
    ...
    },
    {
      ...
      details:
        'Post was confirmed to contain content copied from another website without attribution.',
  ...
  return (
    <Container>
      ...
      <FilterContainer>
        <FilterSelect value={actionType} onChange={handleActionTypeChange}>
        ...
        <FilterSelect value={moderator} onChange={handleModeratorChange}>
      ...
      <CardContainer>
        <LogList>
          {filteredLogs.length > 0 ? (
                    ...
                    <LogMeta>
                      ...
                      {log.contentType && (
                        <LogMetaItem>
                          ...
                          {log.contentType.charAt(0).toUpperCase() + log.contentType.slice(1)} #
                          {log.contentId}
                        </LogMetaItem>
                      )}
                    </LogMeta>
            ...
            <EmptyState>
              ...
              <EmptyState.Title>No moderation logs found</EmptyState.Title>
        ...
        {filteredLogs.length > 0 && (
          <Pagination>
            <PaginationInfo>Showing {filteredLogs.length} logs</PaginationInfo>
            <PaginationButtons>
