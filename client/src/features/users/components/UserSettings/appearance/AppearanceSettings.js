  ...
  return (
    <Container>
      <SettingsCard>
        ...
        <CardContent>
          <ThemeGrid>
            <ThemeOption selected={theme === 'light'} onClick={() => setTheme('light')}>
              <RadioInput type="radio" name="theme" checked={theme === 'light'} readOnly />
            ...
            <ThemeOption selected={theme === 'dark'} onClick={() => setTheme('dark')}>
              <RadioInput type="radio" name="theme" checked={theme === 'dark'} readOnly />
            ...
            <ThemeOption selected={theme === 'system'} onClick={() => setTheme('system')}>
              <RadioInput type="radio" name="theme" checked={theme === 'system'} readOnly />
